...
$string['sitetype'] = 'eLearning site';
$string['sitetypehead'] = 'Choose eLearning site';
$string['sitetypesub'] = 'Chọn loại mô hình bạn muốn triển khai với mỗi loại mô hình sẽ có các chức năng đặc thù cho mô hình đó!';
$string['business'] = 'Mô hình doanh nghiệp';
$string['education'] = 'Mô hình đào tạo';