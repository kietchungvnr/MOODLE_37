...
if ($hassiteconfig
 or has_capability('local/newsvnr:edit', $systemcontext)) {
	...
	$ADMIN->add('learningplanvnr', new admin_externalpage('orgmanager', new lang_string('orgmanagertitle','local_newsvnr'), "$CFG->wwwroot/local/newsvnr/orgmanager.php", array('local/newsvnr:edit')));
