...
$ADMIN->add('root', new admin_category('modules', new lang_string('plugins', 'admin'), true));
...
$ADMIN->add('root', new admin_category('development', new lang_string('development', 'admin'), true));
