define(['jquery', 'kendo.all.min', 'core/config', 'core/notification', 'alertjs'], function($, kendo, Config, Notification, alertify) {
    return {
                    ...
                    var tvajaxx = $.ajax(script, settings)
                        .then(function(response) {
                            if (response.error) {
                                ...
                                debugger
                                if(data.message) {
                                    alertify.warning(data.message, 'warning', 3);
                                    $('#id_courseoforgstructure').prop( "disabled", true );
                                    return;
                                }
