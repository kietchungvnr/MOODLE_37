...
class orgposition_form extends moodleform {
    ...
    function definition () {
        ...
        $mform->addElement('text', 'orgstructureid', get_string('orgstructureid', 'local_newsvnr'), 'maxlength="200" size="50" class="mb-0" onclick="orgposition_treeview()"');
    ...
    //         if (isset($data->orgstructurename)) {
    //             $data->orgstructurename = $DB->get_record_sql('SELECT id FROM {orgstructure} WHERE name = ?',array($data->orgstructurename));
    //         }
