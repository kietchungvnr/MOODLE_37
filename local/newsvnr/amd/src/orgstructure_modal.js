...
define(['jquery', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/ajax', 'core/yui'],
    ...
    NewGroup.prototype.init = function(selector) {
        ...
        return Str.get_string('addnew', 'local_newsvnr').then(function(title) {
            // Create the modal.
    ...
    NewGroup.prototype.getBody = function(formdata) {
        ...
        return Fragment.loadFragment('local_newsvnr', 'new_orgstructure_form', this.contextid, params);
    };
    ...
    NewGroup.prototype.handleFormSubmissionResponse = function() {
        ...
        document.getElementById("orgstructure_list").click();
    };
    ...
    NewGroup.prototype.submitFormAjax = function(e) {
        ...
        // Now we can continue...
        Ajax.call([{
            methodname: 'local_newsvnr_submit_create_orgstructure_form',
