...
$string['addquestionfrombankatend'] = 'Thêm từ ngân hàng câu hỏi vào cuối';
$string['addquestionfrombanktopage'] = 'Thêm từ ngân hàng câu hỏi cho đến timezone_transitions_get() {$a}';
