...
class quiz_mcq_report extends quiz_default_report {
    ...
    protected function output_screen ($warnings, $nodata, $quiz, $reporturl, $groupnames, $filternames, $noofuserattempts,
        ...
        echo '</td></tr><tr><td>';
        echo '<select name="groupid[]" class="form-control" multiple size="5" onchange="document.forms[\'controlform\'].submit();">';
        ...
        echo '<select name="filter" class="form-control" onchange="document.forms[\'controlform\'].submit();">';
        ...
        // Headers
        echo '<tr>';
        echo '<th class="header"><a href="' . qualified_me() . '&sort=' . $sortarg2 . '">'
            . get_string('firstname', 'quiz_mcq') . '</a></th>'
            . '<th class="header"><a href="' . qualified_me() . '&sort=' . $sortarg1 . '">'
        ...
        if (count($uncompletedusers) > 0) {
            ...
            echo '<tbody>';
            echo '<tr>';
            echo '<th class="header">' . get_string('firstname', 'quiz_mcq') . '</th>' . '<th class="header">' . get_string('surname', 'quiz_mcq') . '</th>';
            echo '</tr>';
