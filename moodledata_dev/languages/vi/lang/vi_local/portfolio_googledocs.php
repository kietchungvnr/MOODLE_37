...
$string['nooauthcredentials_help'] = 'Để sử dụng plugin danh mục đầu tư của Google Drive, bạn phải định cấu hình thông tin đăng nhập OAuth trong cài đặt danh mục đầu tư.';
$string['nosessiontoken'] = 'Mã thông báo phiên không tồn tại ngăn xuất khẩu sang google.';
...
$string['privacy:metadata'] = 'Plugin này gửi dữ liệu ra bên ngoài đến tài khoản Google được liên kết. Nó không lưu trữ dữ liệu cục bộ.';
$string['privacy:metadata:data'] = 'Dữ liệu cá nhân được chuyển qua hệ thống con của danh mục đầu tư.';
$string['secret'] = 'Bí mật';
$string['sendfailed'] = 'Tệp {$a} không chuyển được sang google';
