...
if (isloggedin()) {
    ...
    $templatecontext = array_merge($templatecontext, $themesettings->footer_items(), $themesettings->slideshow(),$themesettings->get_news_data(),$themesettings->get_courses_data(),$themesettings->get_discussions_data(),$themesettings->get_btn_add_news(), $themesettings->sectionenable(), $themesettings->get_vnr_chatbot());
