...
$string['totalactivecourse'] = 'Total Activities / Resources';
...
$string['navcoursecolor'] = 'Navigation course colour';
$string['navcoursecolor_desc'] = 'The navigation course colour.';
...
$string['navbar'] = 'Navbar background color';
$string['navbarbghover_desc'] = 'The left navbar hover color';
$string['navbar_desc'] = 'The navbar background color';
...
$string['displayforums'] = 'Show forums section';
$string['displayforumsdesc'] = 'Enable a forums section in frontpage';
$string['numberstudent'] = 'Student';
...
$string['privatedata'] = 'Private files';
$string['coursecategories'] = 'Course category';
$string['mycourses'] = 'My course';
$string['nojoincourse'] = 'Empty data';
$string['owncourses'] = 'My lecture course';
$string['discussionforum'] = 'DISCUSSTION FORUM';
$string['popularcourse'] = 'POPULAR COURSE';
$string['readmore'] = 'Read more';
$string['courseupper'] = 'COURSE';
$string['forumupper'] = 'FORUM';
$string['newsupper'] = 'NEWS';
$string['welcomeupper'] = 'WELCOME TO ELEARNING';
$string['mycoursesupper'] = 'MY COURSE';
$string['wanttosearchyourcourse'] = 'Search courses...';
...
$string['filelibrary'] = "System resource";
...
$string['of'] = 'of';
$string['items'] = 'item';
$string['empty'] = 'No items to display';
$string['itemsPerPage'] = 'items per page';
$string['first'] = 'Go to the first page';
$string['previous'] = 'Go to the previous page';
$string['next'] = 'Go to the next page';
...
$string['coursestartdate'] = "Time open course";
$string['courseenddate'] = "Time end course";
$string['studenttotal'] = "Total student";
$string['studentunfinished'] = "Student unfinished";
$string['courseaveragepoints'] = "Course average points";
$string['timefinishedaverage'] = "Time finished average";
$string['highestpoint'] = "Highest point";
$string['lowestpoint'] = "Lowest point";
$string['number'] = "Number";
$string['studentcode'] = "Student code";
$string['student'] = "Student";
$string['finishdate'] = "Finish date";
$string['processfinish'] = "Process";
$string['grade'] = "Grade";
$string['rank'] = "Rank";
$string['coursemanagement'] = "Course management";
$string['studentmanagement'] = "Student management";
$string['courseofstudent'] = "My course";
$string['teachercode'] = "Teacher code";
$string['enrolledcourse'] = "Enrolled course";
$string['coursejoin'] = "Course teaching";
$string['studyroute'] = "Study route";
$string['teachermanagement'] = "Teacher management";
$string['statistical'] = "Statistical";
$string['searchcourse'] = "Search course";
$string['courselist'] = "Course list";
$string['lastaccess'] = "Last access";
$string['coursecompletion'] = "Course completetion";
...
//Dashbaord giáo viên
$string['views'] = 'Views';
$string['viewscourselow'] = 'Views course';
$string['numberstudent'] = 'Number student';
$string['newenrollstudent'] = 'New enroll student';
$string['totalstudent'] = 'Student total';
$string['numbercompletedcourse'] = 'Number completed course';
$string['avgscore'] = 'Score AVG';
$string['score'] = 'Score';
$string['viewdetail'] = 'View detail';
$string['studentname'] = 'Student name';
$string['phone'] = 'Phone number';
$string['listmodule'] = 'Activity/Resources';
$string['exam'] = 'Exam';
$string['coursetotal'] = 'Course total';
$string['learnertotal'] = 'Learner total';
$string['completeprogress'] = 'Complete progress';
$string['studentcompleted'] = 'Student completed';
$string['studentstudying'] = 'Student studying';
$string['courseavg'] = 'Course AVG';
$string['notifynoseen'] = 'New remind, not seen';
$string['coursenocontent'] = 'Course no content';
$string['interactivereport'] = 'Interactive Report';
$string['viewaccess'] = 'View access';
$string['viewgrade'] = 'View grade';
$string['viewassignment'] = 'View assignment';
$string['viewquiz'] = 'View quiz';
$string['notyetselectcourse'] = 'No course selected';
$string['number'] = 'Number';
$string['moduleallocation'] = 'Module allocation';
$string['access'] = 'Access course';
$string['coursecompleted'] = 'Course completed';
$string['coursegradeavg'] = 'Course grade AVG';
$string['enrollcourse'] = 'Number enroll course';
$string['modulename'] = 'Activity/Resources name';
$string['moduletype'] = 'Module type';
$string['progressing'] = 'Progressing';
$string['finished'] = 'Finished';
$string['plan'] = 'Plan';
$string['courseprogress'] = 'Course progress';
$string['spenttimetotal'] = 'Spent time Learning';
$string['lastaccesstime'] = 'Recent visits {$a}';
$string['remindcourse'] = 'Course remind';
$string['remindorther'] = 'Remind other';
$string['coursenoteacher'] = 'Course no teacher';
$string['coursenostudent'] = 'Course no student';
$string['courseempty'] = 'Course no content';
$string['courserequests'] = 'Course requests';
$string['enrollrequest'] = 'Enroll request';
...
$string['settings_sitetype'] = 'Model type';
...
$string['require_reload'] = 'When the above conditions are fulfilled, please reload the page';