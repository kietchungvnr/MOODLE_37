...
$string['coursesections'] = 'Danh sách chủ đề';
...
$string['gobackward'] = 'Trở về trang sau';
$string['goforward'] = 'Trở về trang trước';
$string['gotop'] = 'Lên đầu trang';
$string['displaynews'] = 'Tin tức';
$string['displaynewsdesc'] = 'Ẩn hoặc hiện mục tin tức ở trang chủ';
$string['displaycoursespopular'] = 'Khóa học phổ biến';
$string['displaycoursespopulardesc'] = 'Ẩn hoặc hiện mục tin tức ở trang chủ';
$string['displaymycourses'] = 'Khóa học của tôi';
$string['displaymycoursesdesc'] = 'Ẩn hoặc hiện mục khóa học của tôi ở trang chủ';
$string['displayforums'] = 'Diễn đàn';
$string['displayforumsdesc'] = 'Ẩn hoặc hiện mục diễn đàn ở trang chủ';