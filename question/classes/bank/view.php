...
class view {
    ...
    protected function display_question_bank_header() {
        ...
        echo \html_writer::tag('div',$OUTPUT->heading(get_string('questionbank', 'question'), 2). '<div class="add-question-bank"><i class="fa fa-plus position-relative" aria-hidden="true" style="top:-4px;"></i></div>',['class' => 'header-questionbank']);
    }
