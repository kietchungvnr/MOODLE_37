...
$string['pluginname'] = 'Xu hướng tham gia hoạt động';
$string['trendactivity'] = 'XU HƯỚNG HOẠT ĐỘNG';
$string['topjoinforum'] = 'TOP HOẠT ĐỘNG DIỄN ĐÀN';
$string['topic'] = 'Chủ đề';
$string['post'] = 'Bài viết';
$string['comment'] = 'Bình luận';
$string['student'] = 'Tên';
$string['rankchart'] = 'BẢNG XẾP HẠNG';
$string['numbercompletedmodules'] = 'Số lượng hoàn thành modules';
