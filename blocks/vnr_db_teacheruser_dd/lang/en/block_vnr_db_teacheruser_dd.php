...
$string['pluginname'] = 'Trend join activity';
$string['trendactivity'] = 'TREND ACTIVITY';
$string['topjoinforum'] = 'TOP JOIN FORUM';
$string['topic'] = 'Topic';
$string['post'] = 'Post';
$string['comment'] = 'Comment';
$string['student'] = 'Name';
$string['rankchart'] = 'RANK TABLE';
$string['numbercompletedmodules'] = 'Number completed modules';
