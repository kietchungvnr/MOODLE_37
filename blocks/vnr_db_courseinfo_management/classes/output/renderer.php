...
class renderer extends plugin_renderer_base {
     ...
     */
    public function render_courseinfo_management_page(courseinfo_management_page $page) {
        return $this->render_from_template('block_vnr_db_courseinfo_management/courseinfo_management',
