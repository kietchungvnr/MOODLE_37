...
$string['pluginname'] = 'Nhắc nhở giáo viên';
$string['simpletext'] = 'Hoạt động thành công';
$string['listcourse'] = 'DANH SÁCH KHÓA HỌC';
$string['listfeedback'] = 'DANH SÁCH PHẢN HỒI';
$string['listassignment'] = 'DANH SÁCH BÀI TẬP';
$string['learningmanagement'] = 'QUẢN LÝ HỌC TẬP';
$string['liststudent'] = 'DANH SÁCH HỌC VIÊN';
