...
<div style="position:absolute;left:0; right:0;top:0; bottom:0;margin:auto;max-width:100%;max-height:100%;
overflow:auto;background-color: white;border-radius: 0px;padding: 20px;text-align: center;">
    <?php
    echo "<input type=\"hidden\" name=\"id\" value=\"$course\">";

    echo "<p style='font-size: 15px;font-weight: bold;color:#455a64'>" . get_string('access_graph', 'block_analytics_graphs') . "</p>";
    echo "<p style='font-size: 14px;font-weight: bold;color:#455a64'>" . get_string('select_items_to_display', 'block_analytics_graphs') . ":</p>";
    ?>
    ...
    <?php
    echo "<input type='button' class='btn-chart' value='" . get_string('btn_select_all', 'block_analytics_graphs') . "' onclick='checkUncheck(true);'>";
    echo "<input type='button' class='btn-chart' value='" . get_string('btn_deselect_all', 'block_analytics_graphs') . "' onclick='checkUncheck(false);'>";
    echo "<input type='submit' class='btn-chart' value='" . get_string('btn_submit', 'block_analytics_graphs') . "''>";
    ?>
    </form>
</div>
</html>
